...
After experiencing my first exposure to **Object-Oriented Programming (OOP)** and participating in different academic projects, I entered a phase where managing coursework became one of my biggest challenges. During this semester, every subject included approximately **six assignments and two quizzes**, which is the standard assessment policy at UET. In addition, practical subjects required regular laboratory sessions and lab reports.

The courses I studied during this semester included **Object-Oriented Programming (OOP)**, **Database Management Systems (DBMS)**, **Digital Logic Design**, **Communication Skills**, and **Probability & Statistics**. Every subject demanded a different learning strategy. Some subjects focused more on theoretical concepts, while others required continuous practical implementation and problem-solving.
...
Among all the subjects, **OOP** and **DBMS** required the most consistent effort. Initially, I found OOP challenging because concepts such as classes, objects, inheritance, and polymorphism were entirely new to me. Writing programs, debugging errors, and understanding object-oriented thinking often consumed many hours.
...
Throughout the semester, **Dr. Bilal Ahmad** guided us not only academically but also professionally and personally. His advice extended beyond classroom concepts. He continuously encouraged students to remain disciplined, focus on continuous learning, and view challenges as opportunities for growth. His mentorship positively influenced many aspects of my university experience.

Looking back, managing assignments, quizzes, and labs was one of the most demanding yet rewarding experiences of my second semester. Although there were stressful moments, missed deadlines, and long nights of study, these experiences significantly contributed to my personal and academic growth.

Today, I realize that assignments and laboratory work are much more than assessment tools. They prepare students for professional life by teaching essential skills such as time management, teamwork, communication, problem-solving, and perseverance. These lessons continue to shape my journey as a Computer Engineering student.
