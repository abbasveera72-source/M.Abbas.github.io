...
I remember returning to my hostel room after lectures and spending hours watching YouTube tutorials in an attempt to understand the concepts. Unfortunately, watching multiple videos sometimes created even more confusion because different instructors explained concepts in different ways. I also tried using AI tools to simplify difficult topics, but many explanations were either too technical or lacked the context that I personally needed. Instead of becoming clearer, the concepts often became more complicated.

At almost the same time, Calculus II introduced another set of difficulties. Transitioning from single-variable calculus to multivariable calculus was far more challenging than I had expected. Concepts involving multiple integrations, vector fields, and infinite series demanded strong visualization skills. I frequently struggled to imagine three-dimensional regions and understand how mathematical expressions represented physical spaces. Solving problems required not only memorization of formulas but also deep conceptual understanding.

The pressure became even greater because Database Management Systems was also demanding significant attention. Unlike programming courses that focused mainly on writing code, DBMS required understanding relational models, normalization, relational algebra, and SQL queries. Initially, database concepts appeared straightforward, but as we moved toward complex queries and normalization techniques, I realized how important conceptual clarity was.
...
For DLD, I began drawing logic circuits manually on paper instead of only reading about them. I purchased a large notebook specifically for practicing Karnaugh maps, sequential circuits, and state diagrams. Drawing each circuit by hand allowed me to visualize how information flowed through different components. Gradually, concepts that once seemed impossible began to make sense.

Similarly, for Calculus II, I stopped focusing exclusively on theoretical reading. Instead, I dedicated long hours to solving practice problems. Whenever I encountered a difficult question, I attempted it multiple times before consulting external resources. Although this process was time-consuming, it significantly improved my confidence.

My approach toward DBMS also changed dramatically. Inspired by the guidance of Dr. Bilal Ahmad, I started treating database assignments as opportunities to experiment rather than merely tasks to complete. Along with my project partners, Abdullah Ahmad Mirza and Muhammad Umar, I spent many evenings working on database exercises, configuring WAMP servers, writing SQL scripts, and troubleshooting errors.

Interestingly, some of our most valuable learning experiences occurred when things went wrong. Queries failed, tables became corrupted, and databases occasionally produced unexpected results. Instead of becoming frustrated, we carefully analyzed each issue and attempted to identify the root cause. This problem-solving mindset, consistently encouraged by Dr. Bilal Ahmad, gradually transformed the way I approached technical challenges.

As the semester progressed, I noticed an important change within myself. The fear that had dominated the early weeks slowly disappeared. Difficult topics no longer seemed impossible; they simply required patience, practice, and persistence. I understood that struggling with challenging material was not evidence of failure. Rather, it was a natural part of becoming an engineer.
